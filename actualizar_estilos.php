...
/**
 * Script para actualizar automáticamente todos los archivos PHP para usar el archivo CSS unificado
...
// Archivos ya actualizados manualmente
$already_updated = [
    'servicios.php',
    'acerca.php',
    'contacto.php',
...
foreach ($files as $file) {
    ...
    if (in_array($filename, $already_updated)) {
        echo "Saltando archivo ya actualizado: " . $filename . "<br>";
        continue;
    }
    ...
    if ($content !== $original_content) {
        ...
        $updated_files++;
        echo "Actualizado: " . $filename . "<br>";
    } else {
        echo "No se requieren cambios en: " . $filename . "<br>";
    }
}
